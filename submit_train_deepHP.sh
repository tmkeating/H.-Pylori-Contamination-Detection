...
#   Training data for each fold: All experiments NOT assigned to this fold (279,221-357,832 patches)
#   
...
#   - Balanced ratios: All folds 1:2.06 to 1:2.33 (target 1:2.28)
#   - Cross-fold consistency: Folds 0,2,3 show realistic metrics; Folds 1,4 anomalously high (potential cross-WSI patch contamination)
...
echo "  - Each fold trains on all other experiments (279K-358K patches, diverse)"
echo "  - Fold 0 val: 7 exps (5 pos, 2 neg) → 85,854 patches (1:2.33 ratio)"
echo "  - Fold 1 val: 10 exps (8 pos, 2 neg) → 37,093 patches (1:2.06 ratio)"
echo "  - Fold 2 val: 5 exps (3 pos, 2 neg) → 78,085 patches (1:2.31 ratio)"
echo "  - Fold 3 val: 4 exps (2 pos, 2 neg) → 78,189 patches (1:2.29 ratio)"
echo "  - Fold 4 val: 7 exps (3 pos, 4 neg) → 115,704 patches (1:2.29 ratio)"
echo ""
