...
echo "✓ Syncing dataset folders..."
rsync -aq "$REMOTE_DATA/CrossValidation/Annotated" "$LOCAL_SCRATCH/CrossValidation/" || true
rsync -aq "$REMOTE_DATA/CrossValidation/Cropped" "$LOCAL_SCRATCH/CrossValidation/" || true
rsync -aq "$REMOTE_DATA/HoldOut" "$LOCAL_SCRATCH/" || true
